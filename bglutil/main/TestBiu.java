...
public class TestBiu {
	...
	public static void main(String[] args) throws Exception{
		...
		SNSMessageGlacierJobRetrieveInventory message = util.evaluateSNSMessageGlacierJobRetrieveInventory(notification.getMessage());
		System.out.println(message.getInventoryRetrievalParameters());
		SNSGlacierInventoryRetrievalParameters parameters = util.evaludateSNSGlacierInventoryRetrievalParameters(message.getInventoryRetrievalParameters());
