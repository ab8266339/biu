...
public class ElasticMapReduceUtil implements IUtil{
	
	public void printAllPhysicalId(Object emr){
		for(ClusterSummary cs:((AmazonElasticMapReduce)emr).listClusters().getClusters()){
