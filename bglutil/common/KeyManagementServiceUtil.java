...
public class KeyManagementServiceUtil implements IUtil{
	public void printAllPhysicalId(Object kms){
		for(AliasListEntry entry:((AWSKMS)kms).listAliases().getAliases()){
