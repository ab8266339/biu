...
public class ElasticLoadbalancingUtil implements IUtil{
	
	public void printAllPhysicalId(Object elb){
		for(LoadBalancerDescription desc:((AmazonElasticLoadBalancing)elb).describeLoadBalancers().getLoadBalancerDescriptions()){
